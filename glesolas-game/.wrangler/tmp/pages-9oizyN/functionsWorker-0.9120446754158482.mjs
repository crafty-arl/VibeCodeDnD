...
var init_utils = __esm({
  "../node_modules/unenv/dist/runtime/_internal/utils.mjs"() {
    init_functionsRoutes_0_7122580550077959();
...
var require_identifier = __commonJS({
  "../node_modules/replicate/lib/identifier.js"(exports, module) {
    ...
    var ModelVersionIdentifier = class _ModelVersionIdentifier {
      static {
        __name(this, "ModelVersionIdentifier");
      }
      /*
       ...
       */
      constructor(owner, name, version2 = null) {
        this.owner = owner;
        this.name = name;
       ...
       */
      static parse(ref2) {
        const match2 = ref2.match(
          /^(?<owner>[^/]+)\/(?<name>[^/:]+)(:(?<version>.+))?$/
        );
        if (!match2) {
          throw new Error(
            `Invalid reference to model version: ${ref2}. Expected format: owner/name or owner/name:version`
          );
        }
        const { owner, name, version: version2 } = match2.groups;
        return new _ModelVersionIdentifier(owner, name, version2);
      }
    };
      ...
      do {
        ...
        try {
          ...
          if (error3 instanceof ApiError) {
            const retryAfter = error3.response.headers.get("Retry-After");
            if (retryAfter) {
      ...
      switch (strategy) {
        ...
        case "default":
          try {
            ...
            if (error3 instanceof ApiError && error3.response.status >= 400 && error3.response.status < 500) {
              throw error3;
            }
...
var require_stream = __commonJS({
  "../node_modules/replicate/vendor/eventsource-parser/stream.js"(exports, module) {
    ...
    __export(input_exports, {
      EventSourceParserStream: /* @__PURE__ */ __name(() => EventSourceParserStream, "EventSourceParserStream")
    });
...
var require_text_decoder_stream = __commonJS({
  "../node_modules/replicate/vendor/streams-text-encoding/text-decoder-stream.js"(exports, module) {
    ...
    var input_exports = {};
    __export(input_exports, {
      TextDecoderStream: /* @__PURE__ */ __name(() => TextDecoderStream, "TextDecoderStream")
    });
    module.exports = __toCommonJS(input_exports);
...
var require_predictions = __commonJS({
  "../node_modules/replicate/lib/predictions.js"(exports, module) {
    ...
    async function createPrediction(options) {
      const { model, version: version2, input, wait, signal, ...data } = options;
      if (data.webhook) {
        try {
          new URL(data.webhook);
        } catch (err) {
...
var require_replicate = __commonJS({
  "../node_modules/replicate/index.js"(exports, module) {
    ...
    var Replicate2 = class {
       ...
       */
      async run(ref2, options, progress) {
        const { wait = { mode: "block" }, signal, ...data } = options;
        const identifier = ModelVersionIdentifier.parse(ref2);
        let prediction;
...
async function onRequestPost(context2) {
  try {
    const { prompt } = await context2.request.json();
    ...
    const apiToken = context2.env.REPLICATE_API_TOKEN;
    if (!apiToken) {
    ...
    console.error("\u274C Replicate generation failed:", error3);
    return new Response(
      JSON.stringify({
...
// api/vectorize.ts
var onRequestPost2, onRequestGet;
  ...
  "api/vectorize.ts"() {
    ...
    onRequestPost2 = /* @__PURE__ */ __name(async (context2) => {
      ...
      try {
        ...
        for (const card of cards) {
          ...
          const embeddings = await env2.AI.run("@cf/baai/bge-base-en-v1.5", {
            text: [cardText]
          });
        ...
        console.error("Vectorize upsert error:", error3);
        return new Response(JSON.stringify({
    ...
    onRequestGet = /* @__PURE__ */ __name(async (context2) => {
      ...
      try {
        ...
        const results = await env2.VECTORIZE.query(queryVector, {
          topK,
          returnValues: false,
          returnMetadata: "all",
        ...
        console.error("Vectorize query error:", error3);
        return new Response(JSON.stringify({
...
// ../.wrangler/tmp/pages-9oizyN/functionsRoutes-0.7122580550077959.mjs
var routes;
var init_functionsRoutes_0_7122580550077959 = __esm({
  "../.wrangler/tmp/pages-9oizyN/functionsRoutes-0.7122580550077959.mjs"() {
    init_generate_image();
    init_vectorize();
    init_vectorize();
...
// ../.wrangler/tmp/bundle-QxqQ4N/middleware-loader.entry.ts
init_functionsRoutes_0_7122580550077959();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// ../.wrangler/tmp/bundle-QxqQ4N/middleware-insertion-facade.js
init_functionsRoutes_0_7122580550077959();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
//# sourceMappingURL=functionsWorker-0.9120446754158482.mjs.map
