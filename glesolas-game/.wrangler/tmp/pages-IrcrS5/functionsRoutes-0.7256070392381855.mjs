import { onRequestPost as __api_generate_audio_ts_onRequestPost } from "C:\\Users\\aaron\\Documents\\VibeCodeDnD\\glesolas-game\\functions\\api\\generate-audio.ts"
...
export const routes = [
    {
      ...
      method: "POST",
      middlewares: [],
      modules: [__api_generate_audio_ts_onRequestPost],
    },
  {
