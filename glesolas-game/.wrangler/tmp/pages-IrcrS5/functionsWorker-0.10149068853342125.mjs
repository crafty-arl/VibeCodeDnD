...
async function onRequestPost(context2) {
  try {
    ...
    const apiKey = context2.env.ELEVENLABS_API_KEY;
    if (!apiKey) {
    ...
    console.error("\u274C Audio generation failed:", error3);
    return new Response(
      JSON.stringify({
        error: "Audio generation failed",
...
// api/vectorize.ts
var onRequestPost3, onRequestGet;
...
// ../.wrangler/tmp/bundle-XvkCf2/middleware-loader.entry.ts
init_functionsRoutes_0_7256070392381855();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// ../.wrangler/tmp/bundle-XvkCf2/middleware-insertion-facade.js
init_functionsRoutes_0_7256070392381855();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
//# sourceMappingURL=functionsWorker-0.10149068853342125.mjs.map
